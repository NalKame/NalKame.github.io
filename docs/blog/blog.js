...
blog.getAllArticles=function(){
    ...
    const arrayAllArticles=[
        ...
        blog.article('2023/0321','GitHubアクセストークン更新',['2023/03/21','2025/08/11','2023/12/29'],['git','Github','サイト作成']),
        ...
        blog.article('2026/0106','bijective numeration - Excelの列名は単純な26進数ではない',['2026/01/06'],['雑感','プログラミング']),
        blog.article('2026/0107','TypeScriptをやる',['2026/01/07','2026/05/04'],['プログラミング']),
        blog.article('2026/0504','占い？',['2026/05/04'],['プログラミング']),
