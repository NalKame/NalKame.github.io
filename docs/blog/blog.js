...
blog.getAllArticles=function(){
    ...
    const arrayAllArticles=[
        ...
        blog.article('20230318','PDFを公開しています',['2023/03/18','2023/03/19'],['PDF','サイト作成']),
        blog.article('20230319','PDF「温度の定義とエントロピー」について',['2023/03/19','2023/03/21'],['PDF','物理']),
        blog.article('20230320','小田原に行った。ういろうを買った。',['2023/03/20','2023/03/21'],['旅行']),
        blog.article('20230321','GitHubアクセストークン更新',['2023/03/21'],['git','Github','サイト作成']),
    ];
    //以下debug用の追加
    if(blog.getDebugMode().isDebug()){
